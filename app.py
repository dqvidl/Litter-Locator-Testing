...
# Create a Streamlit page for Litter Locator
st.title("Litter Locator")
st.markdown(
    "Welcome to Litter Locator! You can find and clean litter locations here. "
    "You can also report new litter locations below."
)
...
# Create a section to report litter
...
if st.button("Submit Report"):
    if location_name and description and latitude and longitude:
        ...
        st.success("Litter location reported successfully!")

# Display a map of reported litter locations
st.header("Reported Litter Locations")
if not reported_locations.empty:
    st.map(reported_locations)
else:
    st.info("No litter locations have been reported yet.")
